...
class Like {
  ...
  ourClickDispatcher(e) {
    let currentLikeBox = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest(".like-box"); // if (currentLikeBox.data("exists") == "yes") { // usando data() -> pega só o valor ao carregar a página

    if (currentLikeBox.attr("data-exists") == "yes") {
      // usando attr() -> pega o valor atualizado
  ...
  createLike(currentLikeBox) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      type: "POST",
      data: {
        designerId: currentLikeBox.data("designer")
      },
      success: response => {
...
/* harmony default export */ __webpack_exports__["default"] = (Like); //////////////// Like sem JQuery do Brad //////////////////////////////////////////////////
