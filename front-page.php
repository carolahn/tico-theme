    ...
    <div class="full-width-split group">
      <div class="full-width-split__one">
        <div class="full-width-split__inner">
          <h2 class="headline headline--small-plus t-center">New Patterns</h2>
            <?php
                $homepagePatterns = new WP_Query(array(
                    'posts_per_page' => 2,
                    'post_type' => 'pattern',
                    'meta_key' => 'suggested_price',
          ...
          <p class="t-center no-margin"><a href="<?php echo get_post_type_archive_link('pattern'); ?>" class="btn btn--blue">View All Patterns</a></p>
        </div>
      </div>
