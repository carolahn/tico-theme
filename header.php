    ...
    <header class="site-header">
      <div class="container">
        <h1 class="school-logo-text float-left">
          <a href="<?php echo site_url(); ?>"><strong>Tico</strong> Croche</a>
        </h1>
        <!-- mobile layout -->
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <ul>
              ...
              <li <?php if(get_post_type() == 'product') echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/products'); ?>">Products</a></li>
              <li <?php if(get_post_type() == 'pattern' OR is_page('for-beginners')) echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('pattern'); ?>">Patterns</a></li>
              <li <?php if(get_post_type() == 'store') echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('store')?>">Stores</a></li>
